...
import com.silverauth.config.DataBaseConfig;
import com.silverauth.config.SecurityConfig;
 ...
 */
@Configuration
@Import({TokenKeyEndpointRegistrar.class, DataBaseConfig.class, SecurityConfig.class})
